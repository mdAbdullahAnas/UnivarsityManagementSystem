...
public class AddUpdatePageStudent extends JFrame implements ActionListener{
...
creditTextField, cgpaTextField;
	...
	public AddUpdatePageStudent(StudentList studentList,AddUpdateGUI addUpdateGUI){
...
//============Middle  Entries  ===========
		...
		String department[]={"CSE","EEE","BBA","LLB","ARCHITECTURE","ENGLISH"};
		JComboBox cmdepartment = new JComboBox(department);
		cmdepartment.setBounds(mid, 190, 200, 30);
		this.add(cmdepartment);
