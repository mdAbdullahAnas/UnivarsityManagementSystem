...
public class ManagementStaff extends JFrame implements ActionListener{
	...
	public ManagementStaff(StaffList staffList,DetailsOpenGUI detailsOpenGUI){
		...
		//  Sub Title 
		JLabel subTitle = new JLabel("Staffs Details");
		...
		showAllButton = new JButton("Show ALL Staffs");
		...
		//  Staff Delete Entry 
		JLabel deleteLabel = new JLabel("Delete By Staff ID");
       ...
       public void actionPerformed(ActionEvent e){
		...
		if(searchButton == e.getSource()){
			...
			//Staff b = staffList.getById( searchTextField.getText() );
			Staff b = staffList.getById(searchTextField.getText());
			if(b!=null){
				textArea.setText( b.getStaffAcademicInfoAsString() );
			}
			else{
			...
			Staff b = staffList.deleteById( deleteTextField.getText() );
			if(b!=null){
				textArea.setText( b.deleteByIdGUI() );
				textArea.setText( "Delete successful");
			}
			else{
				textArea.setText( "NO Staff FOUND\n" );
	...
	public void showAllStaffInScreen(){
